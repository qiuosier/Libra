...
namespace Libra.Class
{
    public class InkingInApp
    {
        ...
        private InkingInApp(StorageFolder dataFolder)
        {
        ...
        public static async Task<InkingInApp> InitializeInking(StorageFolder dataFolder)
        {
            InkingInApp inking = new InkingInApp(dataFolder)
            {
